...
![Homebrew nginx 版本](./images/2020-10-12-macos-install-nginx-1.18.0/1.jpeg)
...
![nginx 最新版本](./images/2020-10-12-macos-install-nginx-1.18.0/2.jpeg)
...
![zlib](./images/2020-10-12-macos-install-nginx-1.18.0/3.jpeg)

### 3. 下载依赖包 [pcre](https://ftp.pcre.org/pub/pcre/)

**注意：** 不能下载最新的 2-x 版本（这个工具的版本号属实有点混乱），不兼容 nginx-1.18.0

![pcre](./images/2020-10-12-macos-install-nginx-1.18.0/4.jpeg)

### 4. 下载依赖包 [OpenSSL](https://www.openssl.org/source/)

我下载的版本是当前的最新版本 `openssl-1.1.1h`

![openssl](./images/2020-10-12-macos-install-nginx-1.18.0/5.jpeg)
...
![新建目录](./images/2020-10-12-macos-install-nginx-1.18.0/6.jpeg)

![解压缩](./images/2020-10-12-macos-install-nginx-1.18.0/7.jpeg)
...
![nginx 启动成功](./images/2020-10-12-macos-install-nginx-1.18.0/8.jpeg)
